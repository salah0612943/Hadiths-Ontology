        ...
        $.ajax({
            ...
            success: function (text) {
                ...
                for (var x = 0; x < obj.rows.length; x++) {
                    ...
                    data += " <p class='w3-col l6 s12 m12 w3-left-align w3-right'>" + obj.rows[x].pnameen + "</p>";
                    data += "</div></li>";
                }
...
function showdata(no) {
    try {
        ...
        document.getElementById('name').value = obj.rows[no].pnamear;
        document.getElementById('ename').value = obj.rows[no].pnameen;
