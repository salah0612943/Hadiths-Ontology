<%@ WebHandler Language="C#" Class="hadth" %>

using System;
using System.Web;
using System.Data;
using System.Data.SqlClient;
public class hadth : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        try
        {
            ...
            if (mode == "add")
            {
                sql = "Insert into subject(snamear,snameen,tid,pid) Values(@name,@ename,'" + tid + "','" + pid + "')";
            ...
            if (mode == "edit")
            {
                sql = "Update  subject set snamear=N'" + name + "' ,snameen='" + ename + "',tid='" + tid + "',pid='" + pid + "' where sid='" + id + "'";
                if (db.Execute(sql))
                {
            ...
            if (sid != "") condition += " and sid like '%" + sid + "%'";
            if (sname != "") condition += " and snamear like N'%" + sname + "%'";
            if (sename != "") condition += " and snameen like '%" + sename + "%'";
            ////========================= sort option
